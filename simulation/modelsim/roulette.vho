...
-- Kval	=>  Location: PIN_E10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \keydecode|keycontrols|Selector2~0_combout\ = (\Liness[0]~input_o\ & (\Liness[3]~input_o\ & (\Liness[2]~input_o\ & \Liness[1]~input_o\)))
...
PORT MAP (
	...
	datad => \keydecode|keycontrols|CurrentState.State_Ack_Waiting~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\,
