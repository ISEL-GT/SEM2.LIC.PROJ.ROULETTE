...
-- Kval	=>  Location: PIN_AA2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \keydecode|keyscan|Penc|PencPartial1|GS~0_combout\ = (\Liness[0]~input_o\ & \Liness[1]~input_o\)
...
-- Equation(s):
-- \keydecode|keycontrols|NextState.State_Scan_Lines~0_combout\ = (!\keydecode|keycontrols|CurrentState.State_Scan_Columns~q\ & (((!\Liness[2]~input_o\) # (!\Liness[3]~input_o\)) # (!\keydecode|keyscan|Penc|PencPartial1|GS~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \keydecode|keyscan|Penc|PencPartial1|GS~0_combout\,
	datab => \Liness[3]~input_o\,
	datac => \Liness[2]~input_o\,
...
-- Equation(s):
-- \keydecode|keycontrols|Selector2~0_combout\ = (\Liness[0]~input_o\ & (\Liness[2]~input_o\ & (\Liness[1]~input_o\ & \Liness[3]~input_o\)))
...
PORT MAP (
	dataa => \Liness[0]~input_o\,
	datab => \Liness[2]~input_o\,
	datac => \Liness[1]~input_o\,
	datad => \Liness[3]~input_o\,
...
-- Equation(s):
-- \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~0_combout\ = \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\ $ (((!\keydecode|keycontrols|CurrentState.State_Scan_Columns~q\ & \keydecode|keycontrols|Selector2~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \keydecode|keycontrols|CurrentState.State_Scan_Columns~q\,
	datac => \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\,
	datad => \keydecode|keycontrols|Selector2~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\,
...
PORT MAP (
	...
	datab => \keydecode|keyscan|Reg|FFD2|Q~q\,
	datad => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|shadow_jsm|state\(3),
...
PORT MAP (
	...
	datab => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irsr_reg\(2),
	datad => \keydecode|keyscan|Reg|FFD1|Q~q\,
...
-- Equation(s):
-- \keydecode|keycontrols|Selector1~0_combout\ = (\keydecode|keycontrols|CurrentState.State_Scan_Lines~q\) # ((\keydecode|keycontrols|CurrentState.State_Val~q\ & ((!\keydecode|keycontrols|Selector2~0_combout\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \keydecode|keycontrols|CurrentState.State_Scan_Lines~q\,
...
-- ((\keydecode|keycontrols|CurrentState.State_Ack_Waiting~q\) # ((\keydecode|keycontrols|CurrentState.State_Val~q\ & \keydecode|keycontrols|Selector2~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \keydecode|keycontrols|CurrentState.State_Val~q\,
	datab => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\,
...
-- Equation(s):
-- \keydecode|keycontrols|Selector0~0_combout\ = (\keydecode|keycontrols|CurrentState.State_Ack_Waiting~q\ & 
-- (\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\ & 
-- ((\keydecode|keycontrols|CurrentState.State_Scan_Columns~q\) # (!\keydecode|keycontrols|Selector2~0_combout\)))) # (!\keydecode|keycontrols|CurrentState.State_Ack_Waiting~q\ & (((\keydecode|keycontrols|CurrentState.State_Scan_Columns~q\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \keydecode|keycontrols|CurrentState.State_Ack_Waiting~q\,
	datab => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\,
...
-- Equation(s):
-- \keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~0_combout\ = \keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ $ (((!\keydecode|keycontrols|CurrentState.State_Scan_Columns~q\ & (\keydecode|keycontrols|Selector2~0_combout\ & 
-- \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\))))
...
PORT MAP (
	...
	datab => \keydecode|keycontrols|Selector2~0_combout\,
	datac => \keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\,
	datad => \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\,
...
-- Equation(s):
-- \keydecode|keyscan|Decoder|Y\(0) = (\keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\) # (\keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keydecode|keyscan|Decoder|Y[2]~0_combout\ = (!\keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keydecode|keyscan|Decoder|Y[2]~1_combout\ = (\keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & !\keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keydecode|keyscan|Decoder|Y[2]~2_combout\ = (\keydecode|keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & \keydecode|keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
