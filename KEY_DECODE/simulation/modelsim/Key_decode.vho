...
SIGNAL \keycontrols|NextState.State_Scan_Lines~0_combout\ : std_logic;
...
SIGNAL \keycontrols|Selector2~1_combout\ : std_logic;
SIGNAL \keycontrols|CurrentState.State_Ack_Waiting~q\ : std_logic;
SIGNAL \keycontrols|Selector0~0_combout\ : std_logic;
...
-- Equation(s):
-- \keycontrols|Selector2~0_combout\ = (\Liness[0]~input_o\ & (\Liness[2]~input_o\ & (\Liness[1]~input_o\ & \Liness[3]~input_o\)))
...
-- Equation(s):
-- \keyscan|Penc|PencPartial1|GS~0_combout\ = (\Liness[0]~input_o\ & \Liness[1]~input_o\)
...
\keycontrols|NextState.State_Scan_Lines~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \keycontrols|NextState.State_Scan_Lines~0_combout\ = (!\keycontrols|CurrentState.State_Scan_Columns~q\ & (((!\keyscan|Penc|PencPartial1|GS~0_combout\) # (!\Liness[2]~input_o\)) # (!\Liness[3]~input_o\)))
...
PORT MAP (
	...
	datab => \Liness[2]~input_o\,
	datac => \keyscan|Penc|PencPartial1|GS~0_combout\,
	datad => \keycontrols|CurrentState.State_Scan_Columns~q\,
	combout => \keycontrols|NextState.State_Scan_Lines~0_combout\);
...
PORT MAP (
	...
	d => \keycontrols|NextState.State_Scan_Lines~0_combout\,
...
-- Equation(s):
-- \keycontrols|Selector1~0_combout\ = (\keycontrols|CurrentState.State_Scan_Lines~q\) # ((\keycontrols|CurrentState.State_Val~q\ & ((!\keycontrols|Selector2~0_combout\) # (!\Kack~input_o\))))
...
PORT MAP (
	dataa => \Kack~input_o\,
	datab => \keycontrols|CurrentState.State_Scan_Lines~q\,
	datac => \keycontrols|Selector2~0_combout\,
...
\keycontrols|Selector2~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \keycontrols|Selector2~1_combout\ = (\Kack~input_o\ & ((\keycontrols|CurrentState.State_Ack_Waiting~q\) # ((\keycontrols|Selector2~0_combout\ & \keycontrols|CurrentState.State_Val~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \keycontrols|Selector2~0_combout\,
	datab => \Kack~input_o\,
	datac => \keycontrols|CurrentState.State_Ack_Waiting~q\,
	datad => \keycontrols|CurrentState.State_Val~q\,
	combout => \keycontrols|Selector2~1_combout\);
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \keycontrols|Selector2~1_combout\,
	clrn => \ALT_INV_Reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\keycontrols|Selector0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \keycontrols|Selector0~0_combout\ = (\keycontrols|Selector2~0_combout\ & (\keycontrols|CurrentState.State_Scan_Columns~q\ & ((\Kack~input_o\) # (!\keycontrols|CurrentState.State_Ack_Waiting~q\)))) # (!\keycontrols|Selector2~0_combout\ & ((\Kack~input_o\) 
...
PORT MAP (
	...
	combout => \keycontrols|Selector0~0_combout\);
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \keycontrols|Selector0~0_combout\,
	clrn => \ALT_INV_Reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \keyscan|Contador|instance_registry_2bits|FFD1|Q~0_combout\ = \keyscan|Contador|instance_registry_2bits|FFD1|Q~q\ $ (((\keycontrols|Selector2~0_combout\ & !\keycontrols|CurrentState.State_Scan_Columns~q\)))
...
-- Equation(s):
-- \keyscan|Contador|instance_registry_2bits|FFD2|Q~0_combout\ = \keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ $ (((\keyscan|Contador|instance_registry_2bits|FFD1|Q~q\ & (\keycontrols|Selector2~0_combout\ & 
-- !\keycontrols|CurrentState.State_Scan_Columns~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \keyscan|Contador|instance_registry_2bits|FFD1|Q~q\,
	datab => \keycontrols|Selector2~0_combout\,
...
-- Equation(s):
-- \keyscan|Decoder|Y\(0) = (\keyscan|Contador|instance_registry_2bits|FFD2|Q~q\) # (\keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keyscan|Decoder|Y[2]~0_combout\ = (!\keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & \keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keyscan|Decoder|Y[2]~1_combout\ = (\keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & !\keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keyscan|Decoder|Y[2]~2_combout\ = (\keyscan|Contador|instance_registry_2bits|FFD2|Q~q\ & \keyscan|Contador|instance_registry_2bits|FFD1|Q~q\)
...
-- Equation(s):
-- \keyscan|Penc|Mux2x1|result~0_combout\ = (\Liness[0]~input_o\ & ((\Liness[2]~input_o\) # (!\Liness[1]~input_o\)))
